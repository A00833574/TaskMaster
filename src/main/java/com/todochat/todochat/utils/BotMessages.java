package com.todochat.todochat.utils;
...
public enum BotMessages {
	...
	ITEM_IN_PROGRESS("Item in progress! Select /todolist to return to the list of todo items, or /start to go to the main screen."),
